      ...
      className="container-fluid  ">
        <div className="row ">
          <div className="col-md-3 py-3">
            ...
            <hr />
            <p>
            Welcome to Fido Marketplace, where shopping meets convenience in the digital realm. 
            Our online e-commerce platform is designed to cater to the diverse needs of modern consumers, 
            offering a seamless and enjoyable shopping experience. Fido brings together a curated selection
             of products from various categories, ensuring that you find everything you need in one place.
            </p>
          </div>
          <div className="col-md-3 py-3">
            ...
            <ul className="list-group list-group-flush">
              ...
              className="list-group-item  text-white border-light">
                <Link
                  to="/"
