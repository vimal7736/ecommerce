      ...
      <nav aria-label="Page navigation">
        <ul className={`pagination ${this.sizing} ${this.alignment}`}>
          {pages.map((page, index) => {
            if (page === LEFT_PAGE)
              return (
                <li key={index} className="page-item text-dark ">
                  <button
                    className="page-link text-dark rounded-circle"
                    aria-label="Previous"
                    onClick={this.handleMoveLeft}
                  >
                    <span aria-hidden="true text-dark">&laquo;</span>
            ...
            if (page === RIGHT_PAGE)
              return (
                <li key={index} className="page-item text-dark">
                  ...
                  >
                    <span aria-hidden="true text-dark">&raquo;</span>
            ...
            return (
              ...
              >
                <a
                  className="page-link text-dark bg-white rounded-circle "
                  href="#!"
